...
if check_password():
    ...
    st.sidebar.markdown("Configure PPE detection, detect all persons (not) wearing hardhats, safety vests and masks.")
    ...
    image = st.file_uploader("Upload an image (above image will be used as default)", type=["jpg", "jpeg"], key="ppe")
    ...
    if predictions: 
        ...
        img = asarray(img)
        color_image = yolov7_detector.detect_ppe(img, hardhats ,vests ,masks , no_hardhats, no_vests, no_masks)
